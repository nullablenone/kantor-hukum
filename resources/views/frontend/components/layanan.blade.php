        ...
        <div class="flex flex-col w-full mt-0 lg:flex-row sm:mt-10 lg:mt-20">
            ...
            <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                    ...
                    <img  class="relative w-20 h-20" src="{{ asset('images/agreement.png') }}" alt="">
                    <h4 class="relative mt-6 text-lg font-bold">Konsultasi Hukum</h4>
                    <p class="relative mt-2 text-base text-center text-gray-600">Memberikan nasihat hukum kepada klien mengenai berbagai masalah hukum yang mereka hadapi.</p>
            ...
            <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                    ...
                    <h4 class="relative mt-6 text-lg font-bold">Litigasi</h4>
                    <p class="relative mt-2 text-base text-center text-gray-600">
                        Mewakili klien di pengadilan dalam berbagai jenis perkara, termasuk perkara perdata, pidana, dan administrasi.
                    </p>
                    <a href="#_" class="relative flex mt-2 text-sm font-medium text-indigo-500 underline">Learn
                        More</a>
                </div>
            ...
            <div class="w-full max-w-md p-4 mx-auto mb-16 lg:mb-0 lg:w-1/3">
                <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                    ...
                    <!-- FEATURE Icon 3 -->
                    <img  class="relative w-20 h-20" src="{{ asset('images/scales.png') }}" alt="">
                    <h4 class="relative mt-6 text-lg font-bold">Hukum Pidana</h4>
                    <p class="relative mt-2 text-base text-center text-gray-600">
                        Membela klien yang dituduh melakukan tindak pidana dan memberikan nasihat tentang proses hukum pidana.</p>
                    <a href="#_" class="relative flex mt-2 text-sm font-medium text-indigo-500 underline">Learn
                        More</a>
                </div>
            </div>
