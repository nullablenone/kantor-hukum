    ...
    <div class="flex-col items-center ">
        <div class="flex flex-col items-center justify-center w-full h-full max-w-2xl pr-8 mx-auto text-center">
            ...
            <p class="my-6 text-xl font-medium text-gray-500">
                Keahlian dan Integritas dalam Setiap Kasus yang Kami Tangani, Demi Mewujudkan Keadilan dan Kepuasan Klien
            </p>
                ...
                <blockquote
                    ...
                    <div class="flex flex-col pr-8">
                        <div class="relative pl-12">
                            ...
                            <h3 class="pl-1 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Sandra
                                Walton <span class="mt-1 text-sm leading-5 text-gray-500 truncate">- CEO
                                    SomeCompany</span></h3>
                            <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                            <p class="mt-2 text-base text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore, hic temporibus vero nobis quam quisquam!
                            </p>
                        </div>
                    </div>
